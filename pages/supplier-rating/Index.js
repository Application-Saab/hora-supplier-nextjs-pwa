                ...
                <div key={order.order_id} className="order-card">
                  ...
                  {order.userReviewRatingArray.length > 0 && (
                    <div className="user-review" style={{ textAlign: 'center' }}>
                      <span style={{ fontSize: '18px', fontWeight: '900' }}>Customer rating: </span>
                      <Image
                        src={star}
                        alt="Star"
                        height={20} // Adjust height to fit design
                      ...
                      <span style={{ fontSize: '18px', paddingLeft: '10px' }}><b>{order.userReviewRatingArray}</b></span>
                    </div>
                  )}
